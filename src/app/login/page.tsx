            ...
            <div className="flex items-center justify-between mt-6">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-green-600 focus:ring-green-500 border-theme-primary rounded"
                />
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative -mt-3 flex justify-center text-sm">
                  <span className="px-2 bg-theme-card text-theme-secondary">Ou continuer avec</span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  ...
                  className="w-full inline-flex justify-center py-2 px-4 border border-theme-primary rounded-lg shadow-theme-sm bg-theme-card text-sm font-medium text-theme-secondary hover:bg-theme-tertiary"
                >
